...
public class InGameLastestBackup implements Runnable {
	...
	Timer delay,timer9;
	public static JLabel Turn, playersbox, tron_theme,P1,P2,P3,P4,P1money,P2money,P3money,P4money,P1title,P2title,P3title,P4title,tossDice,bluemarker,Die1,Die2,Die3,Die4,Die5,Die6;
	
	Thread t1,t2,t3;

	InGameLastestBackup window;
	int totalP, gameTurn;
...
//	public static void main (String[] args) {
		SwingUtilities.invokeLater(new InGameLastestBackup());
...
////	                Icon icon3 = new ImageIcon(getClass().getResource("/resources/backspace.jpg"));
			...
			Turn.setFont(new Font("Tahoma", Font.PLAIN, 26));
			Turn.setForeground(Color.WHITE);
			Turn.setBounds(1400, 50, 300, 50);
...
////					System.out.println(slidernum);
			...
			tron_theme.setBounds(904, 80, 1000, 1000);
...
//				Thread.sleep(300);
	...
	public void changePositionState(int position[]) {
	...
	public void rollDice(int die) throws InterruptedException {
